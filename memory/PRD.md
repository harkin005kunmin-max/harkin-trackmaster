...
- Verified:
  ...
  - `POST /api/admin/login` - returns JWT token (admin: `usmanjaved070@gmail.com` / `admin123`) via both localhost and external preview URL
...
- Admin: `usmanjaved070@gmail.com` / `admin123`
